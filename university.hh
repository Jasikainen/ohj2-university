...
const string WRONG_PARAMS = "Error: Wrong amount or type of parameters.";
const string ALREADY_EXISTS = "Error: Already exists.";
const string INSTANCE_EXISTS = "Error: Instance already exists on this course.";
...
public:
    ...
    /**
     * @brief is_params
     * * @param params: course code, instance, account number
     * Check if the parameters are found under the University
     * @return True if the parameters are valid
     */
    bool is_params(vector <string> params);

private:
    // <Account number, Account*>
    map<int, Account*> accounts_;
    // <Course code, Course*>
    map<string, Course*> courses_;
